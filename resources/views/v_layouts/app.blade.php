            ...
            <div id="responsive-nav">
                ...
                <!-- category nav -->
                    <div class="category-nav">
                        <span class="category-header" data-toggle="collapse" data-target="#collapseCategory" style="cursor: pointer;">
                            Categories <i class="fa fa-list"></i>
                        </span>
                        <ul class="category-list collapse" id="collapseCategory">
                ...
                {{-- <div class="home-wrap"> --}}
                    ...
                    <div id="home-slick">
                        ...
                        <div class="banner banner-1">
                            <img src="{{ asset('banner/banner01.jpg') }}" alt="">
                        ...
                        <!-- banner -->
                        <div class="banner banner-1">
                            <img src="{{ asset('banner/banner02.jpg') }}" alt="">
                        ...
                        <!-- banner -->
                        <div class="banner banner-1">
                            <img src="{{ asset('banner/banner03.jpg') }}" alt="">
                            <div class="banner-caption">
